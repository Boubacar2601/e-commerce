    ...
    foreach($products as $key => $tab)
    {
        ...
        foreach($tab as $key2 => $value) 
        {
            ...
            echo '<td class="text-center">';
                ...
                echo "<a href='?action=modification&id_produit=$tab[id_produit]' class='btn btn-primary me-2 mb-3'><i class='bi bi-pencil-square'></i></a>";

                echo "<a href='?action=suppression&id_produit=$tab[id_produit]' class='btn btn-danger me-2' onclick='return(confirm(\"En êtes certains ?\"));'><i class='bi bi-trash'></i></a>";
...
?>
    ...
    <form method="post" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-12 text-center">
            <button type="submit" class="btn btn-secondary mb-5"><?= ucfirst($_GET['action']) ?> article</button>
        </div>
    </form>
