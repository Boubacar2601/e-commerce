...
// si l'indice 'cat' est definit dans l'url et sa valeur differente de vide, cela veut dire que l'interaute a cliqué sur le lien d'une categorie donc on entre dans le IF et on selectionne en BDD tout les produits liés à la categorie transmise dans lURL
    if(isset($_GET['cat']) && !empty($_GET['cat']))
    {
        ...
        else // sinon la categorie dans l'URL n'est pas connue en BDD, on redirige l'internaute vers la page boutique.php
        {
            header('location: boutique.php');
        }
    }       
    else // sino aucune categorie n'est passée dans l'URL, alors on selectionne l'ensemble de la table produit dans la BDD
    {
            ...
            <div class="card shadow-sm rounded">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-center">
                        <a href="fiche_produit.php?id_produit=<?=$tabProduct['id_produit']?>" class="btn btn-outline- btn-secondary">En savoir plus</a></p>
                </div>
            </div>
        </div>
        <?php endforeach; ?>
